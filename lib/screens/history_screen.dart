...
import 'package:quiz_app/providers/attempts_provider.dart';
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              IconButton(
                ...
                onPressed: () =>
                    ref.read(attemptsProvider.notifier).reload(),
              ),
            ]),
          ),

          // ── Summary stats ─────────────────────────────────────────────────
          if (attemptsAsync.valueOrNull?.isNotEmpty ?? false)
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: _SummaryCard(attempts: attemptsAsync.value!),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.history_edu,
                        color: TC.subText(context), size: 72),
                    const SizedBox(height: 16),
                    Text(
                      'No quiz history yet.',
                      style: TextStyle(
...
class _SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final avgPercent =
    totalPoints > 0 ? (totalScore / totalPoints * 100).round() : 0;
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: _SumStat(
          label: 'Total\nScore',
          value: totalScore.toStringAsFixed(0),
        )),
        Container(width: 1, height: 40, color: Colors.white24),
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: scoreColor, fontWeight: FontWeight.bold, fontSize: 14,
                ),
              ),
            ),
          ]),
