...
class _HomeScreenState extends ConsumerState<HomeScreen>
        ...
        return Dialog(
          ...
          child: Padding(
            ...
            // ── Success state ────────────────────────────────────────
              ...
              Text(
                'The class has been added to your list.',
                style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    final musicOn         = ref.watch(soundProvider);
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      onChanged: (q) => ref
                          .read(classroomSearchProvider.notifier)
                          .state = q,
                      decoration: InputDecoration(
                        hintText: 'Search',
                        hintStyle: TextStyle(
                          color: TC.subText(context), fontSize: 14,
                        ),
                        prefixIcon: Icon(Icons.search,
                            color: TC.subText(context), size: 20),
                        suffixIcon: _searchController.text.isNotEmpty
                            ? IconButton(
                          icon: Icon(Icons.close,
                              size: 18, color: TC.subText(context)),
                          onPressed: () {
              ...
              child: classroomsAsync.when(
                ...
                error: (err, _) {
                  ...
                  return Center(child: Column(
                    ...
                    children: [
                      Icon(Icons.wifi_off,
                          color: TC.subText(context), size: 48),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _ClassroomCard(
                        ...
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                CourseDetailScreen(classroom: c),
                          ),
                        ),
                      );
                    },
